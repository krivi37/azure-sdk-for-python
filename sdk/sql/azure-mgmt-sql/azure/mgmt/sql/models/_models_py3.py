...
class Database(TrackedResource):
    ...
    :ivar status: The status of the database. Possible values include:
     ...
     'OnlineChangingDwPerformanceTiers', 'Disabled', 'Stopping', 'Stopped',
     'Starting'
    ...
    :param read_scale: The state of read-only routing. If enabled, connections
     ...
     may be routed to a readonly secondary replica in the same region. Not
     applicable to a Hyperscale database within an elastic pool. Possible
    ...
    :param federated_client_id: The Client id used for cross tenant per
     database CMK scenario
    :type federated_client_id: str
    :param source_resource_id: The resource identifier of the source
     associated with the create operation of this database.
    ...
    def __init__(self, *, location: str, tags=None, sku=None, identity=None, create_mode=None, collation: str=None, max_size_bytes: int=None, sample_name=None, elastic_pool_id: str=None, source_database_id: str=None, restore_point_in_time=None, source_database_deletion_date=None, recovery_services_recovery_point_id: str=None, long_term_retention_backup_resource_id: str=None, recoverable_database_id: str=None, restorable_dropped_database_id: str=None, catalog_collation=None, zone_redundant: bool=None, license_type=None, read_scale=None, high_availability_replica_count: int=None, secondary_type=None, auto_pause_delay: int=None, requested_backup_storage_redundancy=None, min_capacity: float=None, maintenance_configuration_id: str=None, is_ledger_on: bool=None, federated_client_id: str=None, source_resource_id: str=None, **kwargs) -> None:
...
class DatabaseIdentity(Model):
    ...
    :type user_assigned_identities: dict[str,
     ~azure.mgmt.sql.models.DatabaseUserIdentity]
    """
...
class DatabaseUpdate(Model):
    ...
    def __init__(self, *, sku=None, identity=None, create_mode=None, collation: str=None, max_size_bytes: int=None, sample_name=None, elastic_pool_id: str=None, source_database_id: str=None, restore_point_in_time=None, source_database_deletion_date=None, recovery_services_recovery_point_id: str=None, long_term_retention_backup_resource_id: str=None, recoverable_database_id: str=None, restorable_dropped_database_id: str=None, catalog_collation=None, zone_redundant: bool=None, license_type=None, read_scale=None, high_availability_replica_count: int=None, secondary_type=None, auto_pause_delay: int=None, requested_backup_storage_redundancy=None, min_capacity: float=None, maintenance_configuration_id: str=None, is_ledger_on: bool=None, federated_client_id: str=None, tags=None, **kwargs) -> None:
...
class DatabaseUserIdentity(Model):
    """Azure Active Directory identity configuration for a resource.
...
class DistributedAvailabilityGroup(ProxyResource):
    ...
    :param primary_availability_group_name: The primary availability group
     name
    :type primary_availability_group_name: str
    :param secondary_availability_group_name: The secondary availability group
     name
    :type secondary_availability_group_name: str
    :param replication_mode: The replication mode of a distributed
     availability group. Parameter will be ignored during link creation.
     Possible values include: 'Async', 'Sync'
    :type replication_mode: str or ~azure.mgmt.sql.models.ReplicationMode
    :ivar distributed_availability_group_id: The distributed availability
     group id
    ...
    def __init__(self, *, target_database: str=None, source_endpoint: str=None, primary_availability_group_name: str=None, secondary_availability_group_name: str=None, replication_mode=None, **kwargs) -> None:
...
class ElasticPool(TrackedResource):
    ...
    :type maintenance_configuration_id: str
    :param high_availability_replica_count: The number of secondary replicas
     associated with the elastic pool that are used to provide high
     availability.
    :type high_availability_replica_count: int
    """
    ...
    def __init__(self, *, location: str, tags=None, sku=None, max_size_bytes: int=None, per_database_settings=None, zone_redundant: bool=None, license_type=None, maintenance_configuration_id: str=None, high_availability_replica_count: int=None, **kwargs) -> None:
...
class ElasticPoolUpdate(Model):
    ...
    def __init__(self, *, sku=None, max_size_bytes: int=None, per_database_settings=None, zone_redundant: bool=None, license_type=None, maintenance_configuration_id: str=None, high_availability_replica_count: int=None, tags=None, **kwargs) -> None:
...
class EndpointCertificate(ProxyResource):
    ...
    def __init__(self, *, public_blob: str=None, **kwargs) -> None:
...
class IPv6FirewallRule(ProxyResourceWithWritableName):
    ...
    :ivar type: Resource type.
    :vartype type: str
    :param start_ipv6_address: The start IP address of the firewall rule. Must
     be IPv6 format.
    :type start_ipv6_address: str
    :param end_ipv6_address: The end IP address of the firewall rule. Must be
     IPv6 format. Must be greater than or equal to startIpAddress.
    :type end_ipv6_address: str
    """
    ...
    _attribute_map = {
        ...
        'name': {'key': 'name', 'type': 'str'},
        'type': {'key': 'type', 'type': 'str'},
        'start_ipv6_address': {'key': 'properties.startIPv6Address', 'type': 'str'},
        'end_ipv6_address': {'key': 'properties.endIPv6Address', 'type': 'str'},
    }

    def __init__(self, *, name: str=None, start_ipv6_address: str=None, end_ipv6_address: str=None, **kwargs) -> None:
        super(IPv6FirewallRule, self).__init__(name=name, **kwargs)
        self.start_ipv6_address = start_ipv6_address
        self.end_ipv6_address = end_ipv6_address
...
class LongTermRetentionBackupOperationResult(ProxyResource):
    ...
    :ivar target_backup_storage_redundancy: The storage redundancy type of the
     copied backup. Possible values include: 'Geo', 'Local', 'Zone', 'GeoZone'
...
class ManagedInstance(TrackedResource):
    ...
    :ivar provisioning_state: Possible values include: 'Creating', 'Deleting',
     'Updating', 'Unknown', 'Succeeded', 'Failed', 'Accepted', 'Created',
     'Deleted', 'Unrecognized', 'Running', 'Canceled', 'NotSpecified',
    ...
    :ivar current_backup_storage_redundancy: The storage account type used to
     store backups for this instance. The options are Local
     (LocallyRedundantStorage), Zone (ZoneRedundantStorage), Geo
     (GeoRedundantStorage) and GeoZone(GeoZoneRedundantStorage). Possible
     values include: 'Geo', 'Local', 'Zone', 'GeoZone'
    :vartype current_backup_storage_redundancy: str or
     ~azure.mgmt.sql.models.BackupStorageRedundancy
    :param requested_backup_storage_redundancy: The storage account type to be
     used to store backups for this instance. The options are Local
     (LocallyRedundantStorage), Zone (ZoneRedundantStorage), Geo
     (GeoRedundantStorage) and GeoZone(GeoZoneRedundantStorage). Possible
     values include: 'Geo', 'Local', 'Zone', 'GeoZone'
    :type requested_backup_storage_redundancy: str or
...
class ManagedInstanceDtc(ProxyResource):
    ...
    :ivar type: Resource type.
    :vartype type: str
    :param dtc_enabled: Active status of managed instance DTC.
    :type dtc_enabled: bool
    :param security_settings: Security settings of managed instance DTC.
    :type security_settings:
     ~azure.mgmt.sql.models.ManagedInstanceDtcSecuritySettings
    :param external_dns_suffix_search_list: External dns suffix search list of
     managed instance DTC.
    :type external_dns_suffix_search_list: list[str]
    :ivar dtc_host_name_dns_suffix: Host name dns suffix of managed instance
     DTC.
    :vartype dtc_host_name_dns_suffix: str
    :ivar provisioning_state: Provisioning state of managed instance DTC.
     Possible values include: 'Created', 'InProgress', 'Succeeded', 'Failed',
     'Canceled'
    :vartype provisioning_state: str or
     ~azure.mgmt.sql.models.ProvisioningState
    ...
    def __init__(self, *, dtc_enabled: bool=None, security_settings=None, external_dns_suffix_search_list=None, **kwargs) -> None:
...
class ManagedInstanceDtcSecuritySettings(Model):
    """The Security Settings of managed instance DTC.

    :param transaction_manager_communication_settings: Transaction Manager
     communication settings of managed instance DTC.
    :type transaction_manager_communication_settings:
     ~azure.mgmt.sql.models.ManagedInstanceDtcTransactionManagerCommunicationSettings
    :param xa_transactions_enabled: Allow XA Transactions to managed instance
     DTC.
    :type xa_transactions_enabled: bool
    :param sna_lu6point2_transactions_enabled: Allow SNA LU 6.2 to managed
     instance DTC.
    :type sna_lu6point2_transactions_enabled: bool
    """
    ...
    _attribute_map = {
        ...
        'sna_lu6point2_transactions_enabled': {'key': 'snaLu6point2TransactionsEnabled', 'type': 'bool'},
    }

    def __init__(self, *, transaction_manager_communication_settings=None, xa_transactions_enabled: bool=None, sna_lu6point2_transactions_enabled: bool=None, **kwargs) -> None:
        ...
        self.sna_lu6point2_transactions_enabled = sna_lu6point2_transactions_enabled


class ManagedInstanceDtcTransactionManagerCommunicationSettings(Model):
    """The Transaction Manager Communication Settings of managed instance DTC.

    :param allow_inbound_enabled: Allow Inbound traffic to managed instance
     DTC.
    :type allow_inbound_enabled: bool
    :param allow_outbound_enabled: Allow Outbound traffic of managed instance
     DTC.
    :type allow_outbound_enabled: bool
    :param authentication: Authentication type of managed instance DTC.
    ...
    def __init__(self, *, allow_inbound_enabled: bool=None, allow_outbound_enabled: bool=None, authentication: str=None, **kwargs) -> None:
...
class ManagedServerDnsAlias(ProxyResource):
    ...
    :ivar type: Resource type.
    :vartype type: str
    :ivar azure_dns_record: The fully qualified DNS record for managed server
     alias
...
class ManagedServerDnsAliasAcquisition(Model):
    """A managed server DNS alias acquisition request.

    All required parameters must be populated in order to send to Azure.

    :param old_managed_server_dns_alias_resource_id: Required. The resource ID
     of the managed server DNS alias that will be acquired to point to this
     managed server instead.
    :type old_managed_server_dns_alias_resource_id: str
    """
    ...
    def __init__(self, *, old_managed_server_dns_alias_resource_id: str, **kwargs) -> None:
...
class ManagedServerDnsAliasCreation(Model):
    """A managed server dns alias creation request.

    :param create_dns_record: Whether or not DNS record should be created for
     this alias. Default value: True .
    :type create_dns_record: bool
    """
    ...
    def __init__(self, *, create_dns_record: bool=True, **kwargs) -> None:
...
class RestorableDroppedDatabase(ProxyResource):
    ...
    :ivar backup_storage_redundancy: The storage account type used to store
     backups for this database. Possible values include: 'Geo', 'Local',
     'Zone', 'GeoZone'
    :vartype backup_storage_redundancy: str or
     ~azure.mgmt.sql.models.BackupStorageRedundancy
    """
...
class ServerConnectionPolicy(ProxyResource):
    ...
    :param connection_type: Required. The server connection type. Possible
     values include: 'Default', 'Redirect', 'Proxy'
...
class ServicePrincipal(Model):
    ...
    :ivar tenant_id: The Azure Active Directory tenant id.
    :vartype tenant_id: str
    :param type: Service principal type. Possible values include: 'None',
     'SystemAssigned'
