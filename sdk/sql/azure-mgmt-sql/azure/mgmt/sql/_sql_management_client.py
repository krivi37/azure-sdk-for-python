...
from .operations import DistributedAvailabilityGroupsOperations
from .operations import ServerTrustCertificatesOperations
from .operations import IPv6FirewallRulesOperations
...
from .operations import ManagedServerDnsAliasesOperations
from .operations import SensitivityLabelsOperations
from .operations import RecommendedSensitivityLabelsOperations
from .operations import EndpointCertificatesOperations
from .operations import ManagedInstanceDtcsOperations
from . import models
...
class SqlManagementClient(SDKClient):
    ...
    :ivar distributed_availability_groups: DistributedAvailabilityGroups operations
    :vartype distributed_availability_groups: azure.mgmt.sql.operations.DistributedAvailabilityGroupsOperations
    :ivar server_trust_certificates: ServerTrustCertificates operations
    :vartype server_trust_certificates: azure.mgmt.sql.operations.ServerTrustCertificatesOperations
    :ivar ipv6_firewall_rules: IPv6FirewallRules operations
    ...
    :ivar managed_server_dns_aliases: ManagedServerDnsAliases operations
    :vartype managed_server_dns_aliases: azure.mgmt.sql.operations.ManagedServerDnsAliasesOperations
    ...
    :ivar endpoint_certificates: EndpointCertificates operations
    :vartype endpoint_certificates: azure.mgmt.sql.operations.EndpointCertificatesOperations
    :ivar managed_instance_dtcs: ManagedInstanceDtcs operations
