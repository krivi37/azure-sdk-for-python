...
def build_list_metrics_request(
    ...
    **kwargs  # type: Any
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Sql/servers/{serverName}/elasticPools/{elasticPoolName}/metrics")  # pylint: disable=line-too-long
...
def build_list_metric_definitions_request(
    ...
    **kwargs  # type: Any
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Sql/servers/{serverName}/elasticPools/{elasticPoolName}/metricDefinitions")  # pylint: disable=line-too-long
    path_format_arguments = {
        "subscriptionId": _SERIALIZER.url("subscription_id", subscription_id, 'str'),
        "resourceGroupName": _SERIALIZER.url("resource_group_name", resource_group_name, 'str'),
        "serverName": _SERIALIZER.url("server_name", server_name, 'str'),
...
def build_list_by_server_request(
    ...
    **kwargs  # type: Any
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Sql/servers/{serverName}/elasticPools")  # pylint: disable=line-too-long
    path_format_arguments = {
        "resourceGroupName": _SERIALIZER.url("resource_group_name", resource_group_name, 'str'),
        "serverName": _SERIALIZER.url("server_name", server_name, 'str'),
        "subscriptionId": _SERIALIZER.url("subscription_id", subscription_id, 'str'),
...
def build_get_request(
    ...
    **kwargs  # type: Any
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Sql/servers/{serverName}/elasticPools/{elasticPoolName}")  # pylint: disable=line-too-long
    path_format_arguments = {
        "resourceGroupName": _SERIALIZER.url("resource_group_name", resource_group_name, 'str'),
        "serverName": _SERIALIZER.url("server_name", server_name, 'str'),
        "elasticPoolName": _SERIALIZER.url("elastic_pool_name", elastic_pool_name, 'str'),
...
def build_failover_request(
    ...
    **kwargs  # type: Any
    ...
    api_version = kwargs.pop('api_version', _params.pop('api-version', "2021-08-01-preview"))  # type: str
    # Construct URL
    _url = kwargs.pop("template_url", "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Sql/servers/{serverName}/elasticPools/{elasticPoolName}/failover")  # pylint: disable=line-too-long
    path_format_arguments = {
        "resourceGroupName": _SERIALIZER.url("resource_group_name", resource_group_name, 'str'),
        "serverName": _SERIALIZER.url("server_name", server_name, 'str'),
        "elasticPoolName": _SERIALIZER.url("elastic_pool_name", elastic_pool_name, 'str'),
...
class ElasticPoolsOperations(object):
    ...
    def list_by_server(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> Iterable["_models.ElasticPool"]
    ...
    def _create_or_update_initial(
        ...
        server_name,  # type: str
        elastic_pool_name,  # type: str
        parameters,  # type: Union[_models.ElasticPool, IO]
        **kwargs  # type: Any
    ):
        # type: (...) -> Optional[_models.ElasticPool]
        error_map = {
            401: ClientAuthenticationError, 404: ResourceNotFoundError, 409: ResourceExistsError
        }
        error_map.update(kwargs.pop('error_map', {}) or {})
    ...
    def begin_create_or_update(
        ...
        server_name,  # type: str
        elastic_pool_name,  # type: str
        parameters,  # type: _models.ElasticPool
        **kwargs  # type: Any
    ):
        # type: (...) -> LROPoller[_models.ElasticPool]
    ...
    def _update_initial(
        ...
        server_name,  # type: str
        elastic_pool_name,  # type: str
        parameters,  # type: Union[_models.ElasticPoolUpdate, IO]
        **kwargs  # type: Any
    ):
        # type: (...) -> Optional[_models.ElasticPool]
        error_map = {
    ...
    def begin_update(
        ...
        server_name,  # type: str
        elastic_pool_name,  # type: str
        parameters,  # type: _models.ElasticPoolUpdate
        **kwargs  # type: Any
    ):
        # type: (...) -> LROPoller[_models.ElasticPool]
