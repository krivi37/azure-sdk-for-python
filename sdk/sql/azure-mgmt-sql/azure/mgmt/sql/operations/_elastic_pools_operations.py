    ...
    def list_by_server(
        ...
        def prepare_request(next_link=None):
            if not next_link:
                ...
                query_parameters = {}
                if skip is not None:
                    query_parameters['$skip'] = self._serialize.query("skip", skip, 'long')
                query_parameters['api-version'] = self._serialize.query("api_version", api_version, 'str')
        ...
        if raw:
            header_dict = {}
        deserialized = models.ElasticPoolPaged(internal_paging, self._deserialize.dependencies, header_dict)
