...
def build_get_request(
    ...
    policy_name,  # type: Union[str, "_models.ShortTermRetentionPolicyName"]
    ...
    **kwargs  # type: Any
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Sql/servers/{serverName}/databases/{databaseName}/backupShortTermRetentionPolicies/{policyName}")  # pylint: disable=line-too-long
...
def build_list_by_database_request(
    ...
    **kwargs  # type: Any
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Sql/servers/{serverName}/databases/{databaseName}/backupShortTermRetentionPolicies")  # pylint: disable=line-too-long
    path_format_arguments = {
        "resourceGroupName": _SERIALIZER.url("resource_group_name", resource_group_name, 'str'),
        "serverName": _SERIALIZER.url("server_name", server_name, 'str'),
        "databaseName": _SERIALIZER.url("database_name", database_name, 'str'),
...
class BackupShortTermRetentionPoliciesOperations(object):
    ...
    def get(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> _models.BackupShortTermRetentionPolicy
    ...
    def _create_or_update_initial(
        ...
        database_name,  # type: str
        policy_name,  # type: Union[str, "_models.ShortTermRetentionPolicyName"]
        parameters,  # type: Union[_models.BackupShortTermRetentionPolicy, IO]
        **kwargs  # type: Any
    ):
        # type: (...) -> Optional[_models.BackupShortTermRetentionPolicy]
        error_map = {
            401: ClientAuthenticationError, 404: ResourceNotFoundError, 409: ResourceExistsError
        }
        error_map.update(kwargs.pop('error_map', {}) or {})
    ...
    def begin_create_or_update(
        ...
        database_name,  # type: str
        policy_name,  # type: Union[str, "_models.ShortTermRetentionPolicyName"]
        parameters,  # type: _models.BackupShortTermRetentionPolicy
        **kwargs  # type: Any
    ):
        # type: (...) -> LROPoller[_models.BackupShortTermRetentionPolicy]
        ...
        :return: An instance of LROPoller that returns either BackupShortTermRetentionPolicy or the
    ...
    def list_by_database(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> Iterable["_models.BackupShortTermRetentionPolicy"]
        """Gets a database's short term retention policy.
        ...
        :return: An iterator like instance of either BackupShortTermRetentionPolicy or the result of
         cls(response)
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.sql.models.BackupShortTermRetentionPolicy]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
