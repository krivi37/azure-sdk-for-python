...
def build_get_request(
    ...
    **kwargs  # type: Any
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Sql/managedInstances/{managedInstanceName}/databases/{databaseName}/transparentDataEncryption/{tdeName}")  # pylint: disable=line-too-long
...
def build_list_by_database_request(
    ...
    **kwargs  # type: Any
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Sql/managedInstances/{managedInstanceName}/databases/{databaseName}/transparentDataEncryption")  # pylint: disable=line-too-long
    path_format_arguments = {
        "resourceGroupName": _SERIALIZER.url("resource_group_name", resource_group_name, 'str'),
        "managedInstanceName": _SERIALIZER.url("managed_instance_name", managed_instance_name, 'str'),
        "databaseName": _SERIALIZER.url("database_name", database_name, 'str'),
...
class ManagedDatabaseTransparentDataEncryptionOperations(object):
    ...
    def get(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> _models.ManagedTransparentDataEncryption
    ...
    def create_or_update(
        ...
        database_name,  # type: str
        tde_name,  # type: Union[str, "_models.TransparentDataEncryptionName"]
        parameters,  # type: _models.ManagedTransparentDataEncryption
        **kwargs  # type: Any
    ):
        # type: (...) -> _models.ManagedTransparentDataEncryption
    ...
    def create_or_update(
        ...
        database_name,  # type: str
        tde_name,  # type: Union[str, "_models.TransparentDataEncryptionName"]
        parameters,  # type: Union[_models.ManagedTransparentDataEncryption, IO]
        **kwargs  # type: Any
    ):
        # type: (...) -> _models.ManagedTransparentDataEncryption
        """Updates a database's transparent data encryption configuration.
    ...
    def list_by_database(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> Iterable["_models.ManagedTransparentDataEncryption"]
