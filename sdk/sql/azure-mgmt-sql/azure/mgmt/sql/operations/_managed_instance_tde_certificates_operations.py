...
def build_create_request(
    ...
    **kwargs  # type: Any
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Sql/managedInstances/{managedInstanceName}/tdeCertificates")  # pylint: disable=line-too-long
...
class ManagedInstanceTdeCertificatesOperations(object):
    ...
    def _create_initial(  # pylint: disable=inconsistent-return-statements
        ...
        resource_group_name,  # type: str
        managed_instance_name,  # type: str
        parameters,  # type: Union[_models.TdeCertificate, IO]
        **kwargs  # type: Any
    ):
        # type: (...) -> None
        error_map = {
