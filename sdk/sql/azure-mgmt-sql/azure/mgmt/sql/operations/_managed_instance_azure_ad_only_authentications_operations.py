...
class ManagedInstanceAzureADOnlyAuthenticationsOperations(object):
    ...
    def get(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> _models.ManagedInstanceAzureADOnlyAuthentication
    ...
    def _create_or_update_initial(
        ...
        managed_instance_name,  # type: str
        authentication_name,  # type: Union[str, "_models.AuthenticationName"]
        parameters,  # type: Union[_models.ManagedInstanceAzureADOnlyAuthentication, IO]
        **kwargs  # type: Any
    ):
        # type: (...) -> Optional[_models.ManagedInstanceAzureADOnlyAuthentication]
        error_map = {
            401: ClientAuthenticationError, 404: ResourceNotFoundError, 409: ResourceExistsError
        }
        error_map.update(kwargs.pop('error_map', {}) or {})
    ...
    def begin_create_or_update(
        ...
        managed_instance_name,  # type: str
        authentication_name,  # type: Union[str, "_models.AuthenticationName"]
        parameters,  # type: _models.ManagedInstanceAzureADOnlyAuthentication
        **kwargs  # type: Any
    ):
        # type: (...) -> LROPoller[_models.ManagedInstanceAzureADOnlyAuthentication]
    ...
    def list_by_instance(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> Iterable["_models.ManagedInstanceAzureADOnlyAuthentication"]
        ...
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.sql.models.ManagedInstanceAzureADOnlyAuthentication]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
