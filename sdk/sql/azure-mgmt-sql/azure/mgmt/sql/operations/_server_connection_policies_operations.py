...
class ServerConnectionPoliciesOperations(object):
    ...
    :ivar api_version: The API version to use for the request. Constant value: "2021-05-01-preview".
    """
    ...
    def create_or_update(
        ...
        :return: An instance of LROPoller that returns ServerConnectionPolicy
         or ClientRawResponse<ServerConnectionPolicy> if raw==True
        :rtype:
         ~msrestazure.azure_operation.AzureOperationPoller[~azure.mgmt.sql.models.ServerConnectionPolicy]
         or
         ~msrestazure.azure_operation.AzureOperationPoller[~msrest.pipeline.ClientRawResponse[~azure.mgmt.sql.models.ServerConnectionPolicy]]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
    ...
    def list_by_server(
        ...
        :param operation_config: :ref:`Operation configuration
         overrides<msrest:optionsforoperations>`.
        :return: An iterator like instance of ServerConnectionPolicy
        :rtype:
         ~azure.mgmt.sql.models.ServerConnectionPolicyPaged[~azure.mgmt.sql.models.ServerConnectionPolicy]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
        ...
        if raw:
            header_dict = {}
        deserialized = models.ServerConnectionPolicyPaged(internal_paging, self._deserialize.dependencies, header_dict)

        return deserialized
    list_by_server.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Sql/servers/{serverName}/connectionPolicies'}
