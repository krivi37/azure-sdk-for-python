...
class ServersOperations(object):
    ...
    def _create_or_update_initial(
        ...
        resource_group_name,  # type: str
        server_name,  # type: str
        parameters,  # type: Union[_models.Server, IO]
        **kwargs  # type: Any
    ):
    ...
    def _update_initial(
        ...
        resource_group_name,  # type: str
        server_name,  # type: str
        parameters,  # type: Union[_models.ServerUpdate, IO]
        **kwargs  # type: Any
    ):
        # type: (...) -> Optional[_models.Server]
        error_map = {
    ...
    def _import_database_initial(
        ...
        resource_group_name,  # type: str
        server_name,  # type: str
        parameters,  # type: Union[_models.ImportNewDatabaseDefinition, IO]
        **kwargs  # type: Any
    ):
    ...
    def check_name_availability(
        self,
        parameters,  # type: Union[_models.CheckNameAvailabilityRequest, IO]
        **kwargs  # type: Any
    ):
        # type: (...) -> _models.CheckNameAvailabilityResponse
        """Determines whether a resource can be created with the specified name.
