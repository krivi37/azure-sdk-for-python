...
def build_list_by_managed_instance_request(
    ...
    **kwargs  # type: Any
    ...
    api_version = kwargs.pop('api_version', _params.pop('api-version', "2021-05-01-preview"))  # type: str
    number_of_queries = kwargs.pop('number_of_queries', _params.pop('numberOfQueries', None))  # type: Optional[int]
    databases = kwargs.pop('databases', _params.pop('databases', None))  # type: Optional[str]
    start_time = kwargs.pop('start_time', _params.pop('startTime', None))  # type: Optional[str]
    end_time = kwargs.pop('end_time', _params.pop('endTime', None))  # type: Optional[str]
    interval = kwargs.pop('interval', _params.pop('interval', None))  # type: Optional[Union[str, "_models.QueryTimeGrainType"]]
    aggregation_function = kwargs.pop('aggregation_function', _params.pop('aggregationFunction', None))  # type: Optional[Union[str, "_models.AggregationFunctionType"]]
    observation_metric = kwargs.pop('observation_metric', _params.pop('observationMetric', None))  # type: Optional[Union[str, "_models.MetricType"]]
    accept = _headers.pop('Accept', "application/json")
...
class ManagedInstancesOperations(object):
    ...
    def list_by_instance_pool(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> Iterable["_models.ManagedInstance"]
    ...
    def _create_or_update_initial(
        ...
        resource_group_name,  # type: str
        managed_instance_name,  # type: str
        parameters,  # type: Union[_models.ManagedInstance, IO]
        **kwargs  # type: Any
    ):
    ...
    def _update_initial(
        ...
        resource_group_name,  # type: str
        managed_instance_name,  # type: str
        parameters,  # type: Union[_models.ManagedInstanceUpdate, IO]
        **kwargs  # type: Any
    ):
        # type: (...) -> Optional[_models.ManagedInstance]
        error_map = {
    ...
    def list_by_managed_instance(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> Iterable["_models.TopQueries"]
