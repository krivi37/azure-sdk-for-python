...
def build_list_by_database_request(
    ...
    **kwargs  # type: Any
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Sql/managedInstances/{managedInstanceName}/databases/{databaseName}/securityEvents")  # pylint: disable=line-too-long
...
class ManagedDatabaseSecurityEventsOperations(object):
    ...
    def list_by_database(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> Iterable["_models.SecurityEvent"]
