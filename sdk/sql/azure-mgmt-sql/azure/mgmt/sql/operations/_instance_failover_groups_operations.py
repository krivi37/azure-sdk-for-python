...
def build_get_request(
    ...
    **kwargs  # type: Any
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Sql/locations/{locationName}/instanceFailoverGroups/{failoverGroupName}")  # pylint: disable=line-too-long
...
def build_list_by_location_request(
    ...
    **kwargs  # type: Any
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Sql/locations/{locationName}/instanceFailoverGroups")  # pylint: disable=line-too-long
    path_format_arguments = {
        "resourceGroupName": _SERIALIZER.url("resource_group_name", resource_group_name, 'str'),
        "locationName": _SERIALIZER.url("location_name", location_name, 'str'),
        "subscriptionId": _SERIALIZER.url("subscription_id", subscription_id, 'str'),
...
def build_failover_request(
    ...
    **kwargs  # type: Any
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Sql/locations/{locationName}/instanceFailoverGroups/{failoverGroupName}/failover")  # pylint: disable=line-too-long
    path_format_arguments = {
        "resourceGroupName": _SERIALIZER.url("resource_group_name", resource_group_name, 'str'),
        "locationName": _SERIALIZER.url("location_name", location_name, 'str'),
        "failoverGroupName": _SERIALIZER.url("failover_group_name", failover_group_name, 'str'),
...
def build_force_failover_allow_data_loss_request(
    ...
    **kwargs  # type: Any
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Sql/locations/{locationName}/instanceFailoverGroups/{failoverGroupName}/forceFailoverAllowDataLoss")  # pylint: disable=line-too-long
    path_format_arguments = {
        "resourceGroupName": _SERIALIZER.url("resource_group_name", resource_group_name, 'str'),
        "locationName": _SERIALIZER.url("location_name", location_name, 'str'),
        "failoverGroupName": _SERIALIZER.url("failover_group_name", failover_group_name, 'str'),
...
class InstanceFailoverGroupsOperations(object):
    ...
    def get(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> _models.InstanceFailoverGroup
    ...
    def _create_or_update_initial(
        ...
        location_name,  # type: str
        failover_group_name,  # type: str
        parameters,  # type: Union[_models.InstanceFailoverGroup, IO]
        **kwargs  # type: Any
    ):
        # type: (...) -> Optional[_models.InstanceFailoverGroup]
        error_map = {
            401: ClientAuthenticationError, 404: ResourceNotFoundError, 409: ResourceExistsError
        }
        error_map.update(kwargs.pop('error_map', {}) or {})
    ...
    def begin_create_or_update(
        ...
        location_name,  # type: str
        failover_group_name,  # type: str
        parameters,  # type: _models.InstanceFailoverGroup
        **kwargs  # type: Any
    ):
        # type: (...) -> LROPoller[_models.InstanceFailoverGroup]
    ...
    def list_by_location(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> Iterable["_models.InstanceFailoverGroup"]
