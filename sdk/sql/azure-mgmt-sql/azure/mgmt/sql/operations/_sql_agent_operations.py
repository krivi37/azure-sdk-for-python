...
class SqlAgentOperations(object):
    ...
    def get(
        ...
        :return: SqlAgentConfiguration or ClientRawResponse if raw=true
        :rtype: ~azure.mgmt.sql.models.SqlAgentConfiguration or
        ...
        if response.status_code == 200:
            deserialized = self._deserialize('SqlAgentConfiguration', response)
        ...
        return deserialized
    get.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Sql/managedInstances/{managedInstanceName}/sqlAgent/current'}
    ...
    def create_or_update(
        ...
        return deserialized
    create_or_update.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Sql/managedInstances/{managedInstanceName}/sqlAgent/current'}
