...
def build_list_by_database_request(
    ...
    **kwargs  # type: Any
    ...
    schema = kwargs.pop('schema', _params.pop('schema', None))  # type: Optional[List[str]]
    table = kwargs.pop('table', _params.pop('table', None))  # type: Optional[List[str]]
    column = kwargs.pop('column', _params.pop('column', None))  # type: Optional[List[str]]
    order_by = kwargs.pop('order_by', _params.pop('orderBy', None))  # type: Optional[List[str]]
    skiptoken = kwargs.pop('skiptoken', _params.pop('$skiptoken', None))  # type: Optional[str]
    accept = _headers.pop('Accept', "application/json")

    # Construct URL
    _url = kwargs.pop("template_url", "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Sql/servers/{serverName}/databases/{databaseName}/columns")  # pylint: disable=line-too-long
...
def build_list_by_table_request(
    ...
    **kwargs  # type: Any
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Sql/servers/{serverName}/databases/{databaseName}/schemas/{schemaName}/tables/{tableName}/columns")  # pylint: disable=line-too-long
    path_format_arguments = {
        "resourceGroupName": _SERIALIZER.url("resource_group_name", resource_group_name, 'str'),
        "serverName": _SERIALIZER.url("server_name", server_name, 'str'),
        "databaseName": _SERIALIZER.url("database_name", database_name, 'str'),
...
def build_get_request(
    ...
    **kwargs  # type: Any
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Sql/servers/{serverName}/databases/{databaseName}/schemas/{schemaName}/tables/{tableName}/columns/{columnName}")  # pylint: disable=line-too-long
    path_format_arguments = {
        "resourceGroupName": _SERIALIZER.url("resource_group_name", resource_group_name, 'str'),
        "serverName": _SERIALIZER.url("server_name", server_name, 'str'),
        "databaseName": _SERIALIZER.url("database_name", database_name, 'str'),
...
class DatabaseColumnsOperations(object):
    ...
    def list_by_database(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> Iterable["_models.DatabaseColumn"]
