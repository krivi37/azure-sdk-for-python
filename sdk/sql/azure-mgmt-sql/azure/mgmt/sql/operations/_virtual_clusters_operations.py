...
def build_list_by_resource_group_request(
    ...
    **kwargs  # type: Any
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Sql/virtualClusters")  # pylint: disable=line-too-long
    path_format_arguments = {
        "resourceGroupName": _SERIALIZER.url("resource_group_name", resource_group_name, 'str'),
        "subscriptionId": _SERIALIZER.url("subscription_id", subscription_id, 'str'),
    }
...
class VirtualClustersOperations(object):
    ...
    def update_dns_servers(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> _models.UpdateManagedInstanceDnsServersOperation
    ...
    def list(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> Iterable["_models.VirtualCluster"]
    ...
    def _update_initial(
        ...
        resource_group_name,  # type: str
        virtual_cluster_name,  # type: str
        parameters,  # type: Union[_models.VirtualClusterUpdate, IO]
        **kwargs  # type: Any
    ):
        # type: (...) -> Optional[_models.VirtualCluster]
        error_map = {
            401: ClientAuthenticationError, 404: ResourceNotFoundError, 409: ResourceExistsError
        }
        error_map.update(kwargs.pop('error_map', {}) or {})
    ...
    def begin_update(
        ...
        resource_group_name,  # type: str
        virtual_cluster_name,  # type: str
        parameters,  # type: _models.VirtualClusterUpdate
        **kwargs  # type: Any
    ):
        # type: (...) -> LROPoller[_models.VirtualCluster]
