...
def build_list_by_server_request(
    ...
    **kwargs  # type: Any
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Sql/servers/{serverName}/ipv6FirewallRules")  # pylint: disable=line-too-long
...
def build_get_request(
    ...
    **kwargs  # type: Any
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Sql/servers/{serverName}/ipv6FirewallRules/{firewallRuleName}")  # pylint: disable=line-too-long
    path_format_arguments = {
        "resourceGroupName": _SERIALIZER.url("resource_group_name", resource_group_name, 'str'),
        "serverName": _SERIALIZER.url("server_name", server_name, 'str'),
...
class IPv6FirewallRulesOperations(object):
    ...
    def list_by_server(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> Iterable["_models.IPv6FirewallRule"]
    ...
    def create_or_update(
        ...
        server_name,  # type: str
        firewall_rule_name,  # type: str
        parameters,  # type: _models.IPv6FirewallRule
        **kwargs  # type: Any
    ):
        # type: (...) -> _models.IPv6FirewallRule
    ...
    def create_or_update(
        ...
        server_name,  # type: str
        firewall_rule_name,  # type: str
        parameters,  # type: Union[_models.IPv6FirewallRule, IO]
        **kwargs  # type: Any
    ):
        # type: (...) -> _models.IPv6FirewallRule
        """Creates or updates an IPv6 firewall rule.
