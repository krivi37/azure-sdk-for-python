...
def build_list_by_managed_instance_request(
    ...
    **kwargs  # type: Any
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Sql/managedInstances/{managedInstanceName}/dtc")  # pylint: disable=line-too-long
...
def build_get_request(
    resource_group_name,  # type: str
    managed_instance_name,  # type: str
    dtc_name,  # type: Union[str, "_models.DtcName"]
    subscription_id,  # type: str
    **kwargs  # type: Any
):
    # type: (...) -> HttpRequest
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Sql/managedInstances/{managedInstanceName}/dtc/{dtcName}")  # pylint: disable=line-too-long
    path_format_arguments = {
        "resourceGroupName": _SERIALIZER.url("resource_group_name", resource_group_name, 'str'),
        "managedInstanceName": _SERIALIZER.url("managed_instance_name", managed_instance_name, 'str'),
...
class ManagedInstanceDtcsOperations(object):
    ...
    def list_by_managed_instance(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> Iterable["_models.ManagedInstanceDtc"]
    ...
    def get(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> _models.ManagedInstanceDtc
    ...
    def _create_or_update_initial(
        ...
        managed_instance_name,  # type: str
        dtc_name,  # type: Union[str, "_models.DtcName"]
        parameters,  # type: Union[_models.ManagedInstanceDtc, IO]
        **kwargs  # type: Any
    ):
        # type: (...) -> _models.ManagedInstanceDtc
        error_map = {
    ...
    def begin_create_or_update(
        ...
        managed_instance_name,  # type: str
        dtc_name,  # type: Union[str, "_models.DtcName"]
        parameters,  # type: _models.ManagedInstanceDtc
        **kwargs  # type: Any
    ):
        # type: (...) -> LROPoller[_models.ManagedInstanceDtc]
