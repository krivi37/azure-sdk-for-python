...
def build_get_request(
    ...
    policy_name,  # type: Union[str, "_models.ManagedInstanceLongTermRetentionPolicyName"]
    ...
    **kwargs  # type: Any
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Sql/managedInstances/{managedInstanceName}/databases/{databaseName}/backupLongTermRetentionPolicies/{policyName}")  # pylint: disable=line-too-long
...
def build_list_by_database_request(
    ...
    **kwargs  # type: Any
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Sql/managedInstances/{managedInstanceName}/databases/{databaseName}/backupLongTermRetentionPolicies")  # pylint: disable=line-too-long
    path_format_arguments = {
        "resourceGroupName": _SERIALIZER.url("resource_group_name", resource_group_name, 'str'),
        "managedInstanceName": _SERIALIZER.url("managed_instance_name", managed_instance_name, 'str'),
        "databaseName": _SERIALIZER.url("database_name", database_name, 'str'),
...
class ManagedInstanceLongTermRetentionPoliciesOperations(object):
    ...
    def get(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> _models.ManagedInstanceLongTermRetentionPolicy
    ...
    def _create_or_update_initial(
        ...
        database_name,  # type: str
        policy_name,  # type: Union[str, "_models.ManagedInstanceLongTermRetentionPolicyName"]
        parameters,  # type: Union[_models.ManagedInstanceLongTermRetentionPolicy, IO]
        **kwargs  # type: Any
    ):
        # type: (...) -> Optional[_models.ManagedInstanceLongTermRetentionPolicy]
        error_map = {
            401: ClientAuthenticationError, 404: ResourceNotFoundError, 409: ResourceExistsError
        }
        error_map.update(kwargs.pop('error_map', {}) or {})
    ...
    def begin_create_or_update(
        ...
        database_name,  # type: str
        policy_name,  # type: Union[str, "_models.ManagedInstanceLongTermRetentionPolicyName"]
        parameters,  # type: _models.ManagedInstanceLongTermRetentionPolicy
        **kwargs  # type: Any
    ):
        # type: (...) -> LROPoller[_models.ManagedInstanceLongTermRetentionPolicy]
    ...
    def list_by_database(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> Iterable["_models.ManagedInstanceLongTermRetentionPolicy"]
