...
class VirtualNetworkRulesOperations(object):
    ...
    def _create_or_update_initial(
            self, resource_group_name, server_name, virtual_network_rule_name, parameters, custom_headers=None, raw=False, **operation_config):
        # Construct URL
    ...
    def create_or_update(
            self, resource_group_name, server_name, virtual_network_rule_name, parameters, custom_headers=None, raw=False, polling=True, **operation_config):
