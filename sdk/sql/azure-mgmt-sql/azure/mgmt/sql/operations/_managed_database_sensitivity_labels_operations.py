...
def build_list_current_by_database_request(
    ...
    **kwargs  # type: Any
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Sql/managedInstances/{managedInstanceName}/databases/{databaseName}/currentSensitivityLabels")  # pylint: disable=line-too-long
...
def build_list_recommended_by_database_request(
    ...
    **kwargs  # type: Any
    ...
    api_version = kwargs.pop('api_version', _params.pop('api-version', "2021-11-01-preview"))  # type: str
    skip_token = kwargs.pop('skip_token', _params.pop('$skipToken', None))  # type: Optional[str]
    include_disabled_recommendations = kwargs.pop('include_disabled_recommendations', _params.pop('includeDisabledRecommendations', None))  # type: Optional[bool]
    filter = kwargs.pop('filter', _params.pop('$filter', None))  # type: Optional[str]
    accept = _headers.pop('Accept', "application/json")
...
def build_get_request(
    ...
    **kwargs  # type: Any
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Sql/managedInstances/{managedInstanceName}/databases/{databaseName}/schemas/{schemaName}/tables/{tableName}/columns/{columnName}/sensitivityLabels/{sensitivityLabelSource}")  # pylint: disable=line-too-long
    path_format_arguments = {
        "resourceGroupName": _SERIALIZER.url("resource_group_name", resource_group_name, 'str'),
        "managedInstanceName": _SERIALIZER.url("managed_instance_name", managed_instance_name, 'str'),
        "databaseName": _SERIALIZER.url("database_name", database_name, 'str'),
...
def build_disable_recommendation_request(
    ...
    **kwargs  # type: Any
    ...
    api_version = kwargs.pop('api_version', _params.pop('api-version', "2021-11-01-preview"))  # type: str
    # Construct URL
    _url = kwargs.pop("template_url", "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Sql/managedInstances/{managedInstanceName}/databases/{databaseName}/schemas/{schemaName}/tables/{tableName}/columns/{columnName}/sensitivityLabels/{sensitivityLabelSource}/disable")  # pylint: disable=line-too-long
    path_format_arguments = {
        "resourceGroupName": _SERIALIZER.url("resource_group_name", resource_group_name, 'str'),
        "managedInstanceName": _SERIALIZER.url("managed_instance_name", managed_instance_name, 'str'),
        "databaseName": _SERIALIZER.url("database_name", database_name, 'str'),
...
def build_list_by_database_request(
    ...
    **kwargs  # type: Any
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Sql/managedInstances/{managedInstanceName}/databases/{databaseName}/sensitivityLabels")  # pylint: disable=line-too-long
    path_format_arguments = {
        "resourceGroupName": _SERIALIZER.url("resource_group_name", resource_group_name, 'str'),
        "managedInstanceName": _SERIALIZER.url("managed_instance_name", managed_instance_name, 'str'),
        "databaseName": _SERIALIZER.url("database_name", database_name, 'str'),
...
class ManagedDatabaseSensitivityLabelsOperations(object):
    ...
    def list_current_by_database(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> Iterable["_models.SensitivityLabel"]
    ...
    def update(  # pylint: disable=inconsistent-return-statements
        ...
        managed_instance_name,  # type: str
        database_name,  # type: str
        parameters,  # type: Union[_models.SensitivityLabelUpdateList, IO]
        **kwargs  # type: Any
    ):
        # type: (...) -> None
        """Update sensitivity labels of a given database using an operations batch.
    ...
    def create_or_update(
        ...
        table_name,  # type: str
        column_name,  # type: str
        parameters,  # type: Union[_models.SensitivityLabel, IO]
        **kwargs  # type: Any
    ):
        # type: (...) -> _models.SensitivityLabel
        """Creates or updates the sensitivity label of a given column.
