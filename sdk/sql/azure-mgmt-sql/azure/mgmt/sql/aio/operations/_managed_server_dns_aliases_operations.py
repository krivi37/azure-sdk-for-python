...
from ...operations._managed_server_dns_aliases_operations import build_acquire_request, build_create_or_update_request, build_delete_request, build_get_request, build_list_by_managed_instance_request
T = TypeVar('T')
