...
from ...operations._managed_instance_private_endpoint_connections_operations import build_create_or_update_request, build_delete_request, build_get_request, build_list_by_managed_instance_request
T = TypeVar('T')
...
class ManagedInstancePrivateEndpointConnectionsOperations:
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.sql.models.ManagedInstancePrivateEndpointConnection]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def list_by_managed_instance(
        ...
        managed_instance_name: str,
        **kwargs: Any
    ) -> AsyncIterable["_models.ManagedInstancePrivateEndpointConnection"]:
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.sql.models.ManagedInstancePrivateEndpointConnection]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
