...
from ...operations._instance_pools_operations import build_create_or_update_request, build_delete_request, build_get_request, build_list_by_resource_group_request, build_list_request, build_update_request
T = TypeVar('T')
...
class InstancePoolsOperations:
    ...
    def list_by_resource_group(
        ...
        resource_group_name: str,
        **kwargs: Any
    ) -> AsyncIterable["_models.InstancePool"]:
