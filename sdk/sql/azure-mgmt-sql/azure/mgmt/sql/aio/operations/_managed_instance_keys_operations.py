...
from ...operations._managed_instance_keys_operations import build_create_or_update_request, build_delete_request, build_get_request, build_list_by_instance_request
T = TypeVar('T')
...
class ManagedInstanceKeysOperations:
    ...
    def list_by_instance(
        ...
        **kwargs: Any
    ) -> AsyncIterable["_models.ManagedInstanceKey"]:
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.sql.models.ManagedInstanceKey]
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :return: An instance of AsyncLROPoller that returns either ManagedInstanceKey or the result of
         cls(response)
