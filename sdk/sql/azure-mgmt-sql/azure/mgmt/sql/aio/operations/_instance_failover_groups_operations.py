...
from ...operations._instance_failover_groups_operations import build_create_or_update_request, build_delete_request, build_failover_request, build_force_failover_allow_data_loss_request, build_get_request, build_list_by_location_request
T = TypeVar('T')
