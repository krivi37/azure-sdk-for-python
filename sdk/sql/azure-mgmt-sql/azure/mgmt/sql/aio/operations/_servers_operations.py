...
from ...operations._servers_operations import build_check_name_availability_request, build_create_or_update_request, build_delete_request, build_get_request, build_import_database_request, build_list_by_resource_group_request, build_list_request, build_update_request
T = TypeVar('T')
...
class ServersOperations:
    ...
    async def _create_or_update_initial(
        ...
        resource_group_name: str,
        server_name: str,
        parameters: Union[_models.Server, IO],
        **kwargs: Any
    ...
    async def _update_initial(
        ...
        resource_group_name: str,
        server_name: str,
        parameters: Union[_models.ServerUpdate, IO],
        **kwargs: Any
    ) -> Optional[_models.Server]:
        error_map = {
            401: ClientAuthenticationError, 404: ResourceNotFoundError, 409: ResourceExistsError
    ...
    async def begin_import_database(
        ...
        **kwargs: Any
        ...
        cont_token = kwargs.pop('continuation_token', None)  # type: Optional[str]
        if cont_token is None:
            raw_result = await self._import_database_initial(  # type: ignore
                resource_group_name=resource_group_name,
                server_name=server_name,
                parameters=parameters,
                api_version=api_version,
