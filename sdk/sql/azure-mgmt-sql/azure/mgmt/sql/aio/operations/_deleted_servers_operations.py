...
from ...operations._deleted_servers_operations import build_get_request, build_list_by_location_request, build_list_request, build_recover_request
T = TypeVar('T')
...
class DeletedServersOperations:
    ...
    def list(
        self,
        **kwargs: Any
    ) -> AsyncIterable["_models.DeletedServer"]:
