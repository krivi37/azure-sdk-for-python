...
from ...operations._managed_instances_operations import build_create_or_update_request, build_delete_request, build_failover_request, build_get_request, build_list_by_instance_pool_request, build_list_by_managed_instance_request, build_list_by_resource_group_request, build_list_request, build_update_request
T = TypeVar('T')
