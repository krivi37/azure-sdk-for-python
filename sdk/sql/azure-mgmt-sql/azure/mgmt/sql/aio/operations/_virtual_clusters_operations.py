...
from ...operations._virtual_clusters_operations import build_delete_request, build_get_request, build_list_by_resource_group_request, build_list_request, build_update_dns_servers_request, build_update_request
T = TypeVar('T')
